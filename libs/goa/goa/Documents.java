...
public interface Documents extends Proxy {
    ...
    /**
     * The DocumentsImpl type represents a native instance of the Documents interface.
     */
    class DocumentsImpl extends GObject implements Documents {
        static {
         ...
         */
        public DocumentsImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class DocumentsIface extends TypeInterface {
        ...
        /**
         * Allocate a new DocumentsIface.
         *
         * @param arena to control the memory allocation scope
         */
        public DocumentsIface(Arena arena) {
