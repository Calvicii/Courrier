...
public interface Mail extends Proxy {
    ...
    /**
     * The Mail$Impl type represents a native instance of the Mail interface.
     */
    class Mail$Impl extends GObject implements Mail {
        static {
         ...
         */
        public Mail$Impl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class MailIface extends TypeInterface {
        ...
        private MemorySegment getEmailAddressUpcall(MemorySegment object) {
            try {
                ...
                var _objectCached = (Mail) InstanceCache.getForType(object, Mail$Impl::new);
                if (_objectCached instanceof GObject _gobject) {
                    _gobject.ref();
                }
                var _result = (String) this._getEmailAddressMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                ...
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getEmailAddressMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getEmailAddressMethod");
                return MemorySegment.NULL;
            }
        }
        ...
        private int getImapAcceptSslErrorsUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getImapAcceptSslErrorsMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getImapAcceptSslErrorsMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getImapAcceptSslErrorsMethod");
                return 0;
            }
        }
        ...
        private MemorySegment getImapHostUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getImapHostMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getImapHostMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getImapHostMethod");
                return MemorySegment.NULL;
            }
        }
        ...
        private int getImapSupportedUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getImapSupportedMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getImapSupportedMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getImapSupportedMethod");
                return 0;
            }
        }
        ...
        private int getImapUseSslUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getImapUseSslMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getImapUseSslMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getImapUseSslMethod");
                return 0;
            }
        }
        ...
        private int getImapUseTlsUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getImapUseTlsMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getImapUseTlsMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getImapUseTlsMethod");
                return 0;
            }
        }
        ...
        private MemorySegment getImapUserNameUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getImapUserNameMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getImapUserNameMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getImapUserNameMethod");
                return MemorySegment.NULL;
            }
        }
        ...
        private MemorySegment getNameUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getNameMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getNameMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getNameMethod");
                return MemorySegment.NULL;
            }
        }
        ...
        private int getSmtpAcceptSslErrorsUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpAcceptSslErrorsMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpAcceptSslErrorsMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpAcceptSslErrorsMethod");
                return 0;
            }
        }
        ...
        private int getSmtpAuthLoginUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpAuthLoginMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpAuthLoginMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpAuthLoginMethod");
                return 0;
            }
        }
        ...
        private int getSmtpAuthPlainUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpAuthPlainMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpAuthPlainMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpAuthPlainMethod");
                return 0;
            }
        }
        ...
        private int getSmtpAuthXoauth2Upcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpAuthXoauth2Method.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpAuthXoauth2Method");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpAuthXoauth2Method");
                return 0;
            }
        }
        ...
        private MemorySegment getSmtpHostUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getSmtpHostMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpHostMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpHostMethod");
                return MemorySegment.NULL;
            }
        }
        ...
        private int getSmtpSupportedUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpSupportedMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpSupportedMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpSupportedMethod");
                return 0;
            }
        }
        ...
        private int getSmtpUseAuthUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpUseAuthMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpUseAuthMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpUseAuthMethod");
                return 0;
            }
        }
        ...
        private int getSmtpUseSslUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpUseSslMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpUseSslMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpUseSslMethod");
                return 0;
            }
        }
        ...
        private int getSmtpUseTlsUpcall(MemorySegment object) {
            try {
                ...
                var _result = (boolean) this._getSmtpUseTlsMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                return _result ? 1 : 0;
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpUseTlsMethod");
                return 0;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpUseTlsMethod");
                return 0;
            }
        }
        ...
        private MemorySegment getSmtpUserNameUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getSmtpUserNameMethod.invoke((Mail) InstanceCache.getForType(object, Mail$Impl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getSmtpUserNameMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getSmtpUserNameMethod");
                return MemorySegment.NULL;
            }
        }
    }
