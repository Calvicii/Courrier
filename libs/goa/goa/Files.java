...
public interface Files extends Proxy {
    ...
    /**
     * The Files$Impl type represents a native instance of the Files interface.
     */
    class Files$Impl extends GObject implements Files {
        static {
         ...
         */
        public Files$Impl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class FilesIface extends TypeInterface {
        ...
        private int getAcceptSslErrorsUpcall(MemorySegment object) {
            try {
                ...
                var _objectCached = (Files) InstanceCache.getForType(object, Files$Impl::new);
                if (_objectCached instanceof GObject _gobject) {
                    _gobject.ref();
                }
                var _result = (boolean) this._getAcceptSslErrorsMethod.invoke((Files) InstanceCache.getForType(object, Files$Impl::new));
                return _result ? 1 : 0;
        ...
        private MemorySegment getUriUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getUriMethod.invoke((Files) InstanceCache.getForType(object, Files$Impl::new));
