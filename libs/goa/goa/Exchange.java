...
public interface Exchange extends Proxy {
     ...
     *
     * @return The property value or {@code null} if the property is not set. Do not free the returned value, it belongs to this Exchange.
     * @since 3.6.0
     */
    ...
    /**
     * The ExchangeImpl type represents a native instance of the Exchange interface.
     */
    class ExchangeImpl extends GObject implements Exchange {
        static {
         ...
         */
        public ExchangeImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class ExchangeIface extends TypeInterface {
        ...
        /**
         * Allocate a new ExchangeIface.
         *
         * @param arena to control the memory allocation scope
         */
        public ExchangeIface(Arena arena) {
        ...
        private int getAcceptSslErrorsUpcall(MemorySegment object) {
            try {
                ...
                var _objectCached = (Exchange) InstanceCache.getForType(object, ExchangeImpl::new);
                if (_objectCached instanceof GObject _gobject) {
                    _gobject.ref();
                }
                var _result = (boolean) this._getAcceptSslErrorsMethod.invoke((Exchange) InstanceCache.getForType(object, ExchangeImpl::new));
                return _result ? 1 : 0;
        ...
        private MemorySegment getHostUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getHostMethod.invoke((Exchange) InstanceCache.getForType(object, ExchangeImpl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, ite.getCause().toString() + " in " + _getHostMethod);
