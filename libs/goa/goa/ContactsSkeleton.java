...
/**
 * The {@code GoaContactsSkeleton} structure contains only private data and should only be accessed using the provided API.
 */
@Generated("io.github.jwharm.JavaGI")
public class ContactsSkeleton extends DBusInterfaceSkeleton implements DBusInterface, Contacts {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a ContactsSkeleton proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public ContactsSkeleton(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new ContactsSkeleton.
     */
    ...
    /**
     * Get the GType of the ContactsSkeleton class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_contacts_skeleton_get_type");
    }
     ...
     * parent type.
     */
    protected ContactsSkeleton asParent() {
        ContactsSkeleton _parent = new ContactsSkeleton(handle());
        _parent.callParent(true);
        return _parent;
    }

    /**
     * A {@link Builder} object constructs a {@code ContactsSkeleton}
    ...
    /**
     * Class structure for {@code GoaContactsSkeleton}.
     */
    public static class ContactsSkeletonClass extends DBusInterfaceSkeleton.DBusInterfaceSkeletonClass {
        /**
         * Create a ContactsSkeletonClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public ContactsSkeletonClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new ContactsSkeletonClass.
         *
         * @param arena to control the memory allocation scope
         */
        public ContactsSkeletonClass(Arena arena) {
        ...
        public static MemoryLayout getMemoryLayout() {
            ...
            ).withName("GoaContactsSkeletonClass");
        }
    }
     ...
     */
    public static class Builder<B extends Builder<B>> extends DBusInterfaceSkeleton.Builder<B> implements Contacts.Builder<B> {
        /**
        ...
        /**
         * Finish building the {@code ContactsSkeleton} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code ContactsSkeleton}.
         *
         * @return a new instance of {@code ContactsSkeleton} with the properties
         *         that were set in the Builder object.
         */
        public ContactsSkeleton build() {
            try {
                var _instance = (ContactsSkeleton) GObject.withProperties(ContactsSkeleton.getType(), getNames(), getValues());
