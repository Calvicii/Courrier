...
public interface Photos extends Proxy {
    ...
    /**
     * The PhotosImpl type represents a native instance of the Photos interface.
     */
    class PhotosImpl extends GObject implements Photos {
        static {
         ...
         */
        public PhotosImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class PhotosIface extends TypeInterface {
        ...
        /**
         * Allocate a new PhotosIface.
         *
         * @param arena to control the memory allocation scope
         */
        public PhotosIface(Arena arena) {
