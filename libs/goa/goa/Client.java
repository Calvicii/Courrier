...
public class Client extends GObject implements AsyncInitable, Initable {
    ...
    public List<GoaObject> getAccounts() {
        ...
        List<GoaObject> _returnValue = new List<GoaObject>(_result, _ptr -> (GoaObject) InstanceCache.getForType(_ptr, GoaObject.Object$Impl::new), (_p -> ((GObject) _p).unref()), TransferOwnership.FULL);
        return _returnValue;
    }

    /**
     * Gets the {@link Manager} for {@code self,} if any.
     *
    ...
    /**
     * Gets the {@link org.gnome.gio.DBusObjectManager} used by {@code self.}
     *
    ...
    public DBusObjectManager getObjectManager() {
        ...
        DBusObjectManager _returnValue = (DBusObjectManager) InstanceCache.getForType(_result, DBusObjectManager.DBusObjectManager$Impl::new);
        if (_returnValue instanceof GObject _gobject) {
            _gobject.ref();
        }
        return _returnValue;
    ...
    public GoaObject lookupById(String id) {
        try (var _arena = Arena.ofConfined()) {
            ...
            GoaObject _returnValue = (GoaObject) InstanceCache.getForType(_result, GoaObject.Object$Impl::new);
            return _returnValue;
        }
    }
    ...
    public interface AccountAddedCallback extends FunctionPointer {
        ...
        default void upcall(MemorySegment sourceClient, MemorySegment object) {
            try {
                var _objectCached = (GoaObject) InstanceCache.getForType(object, GoaObject.Object$Impl::new);
                if (_objectCached instanceof GObject _gobject) {
                    _gobject.ref();
                }
                run((GoaObject) InstanceCache.getForType(object, GoaObject.Object$Impl::new));
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in AccountAddedCallback");
            }
        }
    ...
    public interface AccountChangedCallback extends FunctionPointer {
        ...
        default void upcall(MemorySegment sourceClient, MemorySegment object) {
            try {
                ...
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in AccountChangedCallback");
            }
        }
    ...
    public interface AccountRemovedCallback extends FunctionPointer {
        ...
        default void upcall(MemorySegment sourceClient, MemorySegment object) {
            try {
                ...
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in AccountRemovedCallback");
            }
        }
