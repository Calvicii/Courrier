...
/**
 * The {@code GoaManagerSkeleton} structure contains only private data and should only be accessed using the provided API.
 */
@Generated("io.github.jwharm.JavaGI")
public class ManagerSkeleton extends DBusInterfaceSkeleton implements DBusInterface, Manager {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a ManagerSkeleton proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public ManagerSkeleton(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new ManagerSkeleton.
     */
    ...
    /**
     * Get the GType of the ManagerSkeleton class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_manager_skeleton_get_type");
    }
     ...
     * parent type.
     */
    protected ManagerSkeleton asParent() {
        ManagerSkeleton _parent = new ManagerSkeleton(handle());
        _parent.callParent(true);
        return _parent;
    }

    /**
     * A {@link Builder} object constructs a {@code ManagerSkeleton}
    ...
    /**
     * Class structure for {@code GoaManagerSkeleton}.
     */
    public static class ManagerSkeletonClass extends DBusInterfaceSkeleton.DBusInterfaceSkeletonClass {
        /**
         * Create a ManagerSkeletonClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public ManagerSkeletonClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new ManagerSkeletonClass.
         *
         * @param arena to control the memory allocation scope
         */
        public ManagerSkeletonClass(Arena arena) {
        ...
        public static MemoryLayout getMemoryLayout() {
            ...
            ).withName("GoaManagerSkeletonClass");
        }
    }
    ...
    public static class Builder<B extends Builder<B>> extends DBusInterfaceSkeleton.Builder<B> {
        ...
        /**
         * Finish building the {@code ManagerSkeleton} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code ManagerSkeleton}.
         *
         * @return a new instance of {@code ManagerSkeleton} with the properties
         *         that were set in the Builder object.
         */
        public ManagerSkeleton build() {
            try {
                var _instance = (ManagerSkeleton) GObject.withProperties(ManagerSkeleton.getType(), getNames(), getValues());
