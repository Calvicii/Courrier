...
/**
 * The {@code GoaChatSkeleton} structure contains only private data and should only be accessed using the provided API.
 */
@Generated("io.github.jwharm.JavaGI")
public class ChatSkeleton extends DBusInterfaceSkeleton implements DBusInterface, Chat {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a ChatSkeleton proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public ChatSkeleton(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new ChatSkeleton.
     */
    public ChatSkeleton() {
    ...
    /**
     * Get the GType of the ChatSkeleton class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_chat_skeleton_get_type");
    }
     ...
     * parent type.
     */
    protected ChatSkeleton asParent() {
        ChatSkeleton _parent = new ChatSkeleton(handle());
        _parent.callParent(true);
        return _parent;
    }

    /**
     * A {@link Builder} object constructs a {@code ChatSkeleton}
    ...
    /**
     * Class structure for {@code GoaChatSkeleton}.
     */
    public static class ChatSkeletonClass extends DBusInterfaceSkeleton.DBusInterfaceSkeletonClass {
        /**
         * Create a ChatSkeletonClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public ChatSkeletonClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new ChatSkeletonClass.
         *
         * @param arena to control the memory allocation scope
         */
        public ChatSkeletonClass(Arena arena) {
    ...
    public static class Builder<B extends Builder<B>> extends DBusInterfaceSkeleton.Builder<B> {
        ...
        /**
         * Finish building the {@code ChatSkeleton} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code ChatSkeleton}.
         *
         * @return a new instance of {@code ChatSkeleton} with the properties
         *         that were set in the Builder object.
         */
        public ChatSkeleton build() {
            try {
                var _instance = (ChatSkeleton) GObject.withProperties(ChatSkeleton.getType(), getNames(), getValues());
