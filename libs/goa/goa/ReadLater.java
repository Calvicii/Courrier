...
public interface ReadLater extends Proxy {
    ...
    /**
     * The ReadLater$Impl type represents a native instance of the ReadLater interface.
     */
    class ReadLater$Impl extends GObject implements ReadLater {
        static {
         ...
         */
        public ReadLater$Impl(MemorySegment address) {
            super(address);
        }
    }
