...
@Deprecated
public interface Printers extends Proxy {
    /**
     * Get the GType of the Printers class
     *
     * @return the GType
     */
    static Type getType() {
        return Interop.getType("goa_printers_get_type");
    }
    ...
    static DBusInterfaceInfo interfaceInfo() {
        ...
        try {
            _result = (MemorySegment) PrintersMethodHandles.goa_printers_interface_info.invokeExact(
                    );
    ...
    /**
     * Overrides all {@code GObject} properties in the {@code GoaPrinters} interface for a concrete class.
    ...
    static int overrideProperties(GObject.ObjectClass klass, int propertyIdBegin) {
        int _result;
        try {
            _result = (int) PrintersMethodHandles.goa_printers_override_properties.invokeExact(
    ...
    /**
     * The Printers$Impl type represents a native instance of the Printers interface.
     */
    class Printers$Impl extends GObject implements Printers {
        static {
            Goa.javagi$ensureInitialized();
        }

        /**
         * Creates a new instance of Printers for the provided memory address.
         *
         * @param address the memory address of the instance
         */
        public Printers$Impl(MemorySegment address) {
            super(address);
        }
    }
     ...
     */
    @Deprecated
    class PrintersIface extends TypeInterface {
        /**
         * Create a PrintersIface proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public PrintersIface(MemorySegment address) {
