...
public interface Printers extends Proxy {
    ...
    /**
     * The PrintersImpl type represents a native instance of the Printers interface.
     */
    class PrintersImpl extends GObject implements Printers {
        static {
         ...
         */
        public PrintersImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class PrintersIface extends TypeInterface {
        ...
        /**
         * Allocate a new PrintersIface.
         *
         * @param arena to control the memory allocation scope
         */
        public PrintersIface(Arena arena) {
