...
/**
 * The {@code GoaContactsProxy} structure contains only private data and should only be accessed using the provided API.
 */
@Generated("io.github.jwharm.JavaGI")
public class ContactsProxy extends DBusProxy implements AsyncInitable, DBusInterface, Initable, Contacts {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a ContactsProxy proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public ContactsProxy(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new ContactsProxy.
     */
    ...
    /**
     * Get the GType of the ContactsProxy class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_contacts_proxy_get_type");
    }
     ...
     * parent type.
     */
    protected ContactsProxy asParent() {
        ContactsProxy _parent = new ContactsProxy(handle());
     ...
     *
     * @param res The {@code GAsyncResult} obtained from the {@code GAsyncReadyCallback} passed to goa_contacts_proxy_new().
     ...
     */
    public static ContactsProxy finish(AsyncResult res) throws GErrorException {
        var _result = constructFinish(res);
        return (ContactsProxy) InstanceCache.getForType(_result, ContactsProxy::new);
    }
    ...
    private static MemorySegment constructFinish(AsyncResult res) throws GErrorException {
        try (var _arena = Arena.ofConfined()) {
            ...
            try {
                _result = (MemorySegment) MethodHandles.goa_contacts_proxy_new_finish.invokeExact(
     ...
     *
     * @param res The {@code GAsyncResult} obtained from the {@code GAsyncReadyCallback} passed to goa_contacts_proxy_new_for_bus().
     * @return The constructed proxy object or {@code null} if {@code error} is set.
     * @throws GErrorException see {@link org.gnome.glib.GError}
     */
    public static ContactsProxy forBusFinish(AsyncResult res) throws GErrorException {
    ...
    private static MemorySegment constructForBusFinish(AsyncResult res) throws GErrorException {
        try (var _arena = Arena.ofConfined()) {
            ...
            MemorySegment _result;
            try {
                _result = (MemorySegment) MethodHandles.goa_contacts_proxy_new_for_bus_finish.invokeExact(
                        (MemorySegment) (res == null ? MemorySegment.NULL : res.handle()), _gerror);
            } catch (Throwable _err) {
                throw new AssertionError(_err);
            }
    ...
    /**
     * Like goa_contacts_proxy_new_sync() but takes a {@code GBusType} instead of a {@code GDBusConnection}.
     * <p>
     ...
     * @throws GErrorException see {@link org.gnome.glib.GError}
     */
    public static ContactsProxy forBusSync(BusType busType, Set<DBusProxyFlags> flags, String name,
    ...
    private static MemorySegment constructForBusSync(BusType busType, Set<DBusProxyFlags> flags,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            MemorySegment _result;
            try {
                _result = (MemorySegment) MethodHandles.goa_contacts_proxy_new_for_bus_sync.invokeExact(
     ...
     * @throws GErrorException see {@link org.gnome.glib.GError}
     */
    public static ContactsProxy forBusSync(BusType busType, DBusProxyFlags flags, String name,
            String objectPath, @Nullable Cancellable cancellable) throws GErrorException {
     ...
     * @throws GErrorException see {@link org.gnome.glib.GError}
     */
    public static ContactsProxy sync(DBusConnection connection, Set<DBusProxyFlags> flags,
    ...
    private static MemorySegment constructSync(DBusConnection connection, Set<DBusProxyFlags> flags,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            MemorySegment _result;
            try {
                _result = (MemorySegment) MethodHandles.goa_contacts_proxy_new_sync.invokeExact(
     ...
     * @throws GErrorException see {@link org.gnome.glib.GError}
     */
    public static ContactsProxy sync(DBusConnection connection, DBusProxyFlags flags,
            @Nullable String name, String objectPath, @Nullable Cancellable cancellable) throws
            GErrorException {
    ...
    public static void new_(DBusConnection connection, Set<DBusProxyFlags> flags,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            try {
                MethodHandles.goa_contacts_proxy_new.invokeExact(
                        (MemorySegment) (connection == null ? MemorySegment.NULL : connection.handle()), 
                        Interop.enumSetToInt(flags), 
                        (MemorySegment) (name == null ? MemorySegment.NULL : Interop.allocateNativeString(name, _arena)), 
                        (MemorySegment) (objectPath == null ? MemorySegment.NULL : Interop.allocateNativeString(objectPath, _arena)), 
    ...
    /**
     * Like goa_contacts_proxy_new() but takes a {@code GBusType} instead of a {@code GDBusConnection}.
     * <p>
     * When the operation is finished, {@code callback} will be invoked in the thread-default main loop of the thread you are calling this method from (see g_main_context_push_thread_default()).
    ...
    public static void newForBus(BusType busType, Set<DBusProxyFlags> flags, String name,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            if (callback != null) ArenaCloseAction.CLEANER.register(callback, new ArenaCloseAction(_callbackScope));
            try {
                MethodHandles.goa_contacts_proxy_new_for_bus.invokeExact(busType.getValue(), 
                        Interop.enumSetToInt(flags), 
                        (MemorySegment) (name == null ? MemorySegment.NULL : Interop.allocateNativeString(name, _arena)), 
                        (MemorySegment) (objectPath == null ? MemorySegment.NULL : Interop.allocateNativeString(objectPath, _arena)), 
                        (MemorySegment) (cancellable == null ? MemorySegment.NULL : cancellable.handle()), 
    ...
    /**
     * A {@link Builder} object constructs a {@code ContactsProxy}
    ...
    /**
     * Class structure for {@code GoaContactsProxy}.
     */
    public static class ContactsProxyClass extends DBusProxy.DBusProxyClass {
        /**
         * Create a ContactsProxyClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public ContactsProxyClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new ContactsProxyClass.
         *
         * @param arena to control the memory allocation scope
         */
        public ContactsProxyClass(Arena arena) {
        ...
        public static MemoryLayout getMemoryLayout() {
            ...
            ).withName("GoaContactsProxyClass");
        }
    }
     ...
     */
    public static class Builder<B extends Builder<B>> extends DBusProxy.Builder<B> implements Contacts.Builder<B> {
        /**
        ...
        /**
         * Finish building the {@code ContactsProxy} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code ContactsProxy}.
         *
         * @return a new instance of {@code ContactsProxy} with the properties
         *         that were set in the Builder object.
         */
        public ContactsProxy build() {
            try {
                var _instance = (ContactsProxy) GObject.withProperties(ContactsProxy.getType(), getNames(), getValues());
    ...
    private static final class MethodHandles {
        static final MethodHandle goa_contacts_proxy_new_finish = Interop.downcallHandle(
                "goa_contacts_proxy_new_finish", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_contacts_proxy_new_for_bus_finish = Interop.downcallHandle(
                "goa_contacts_proxy_new_for_bus_finish", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_contacts_proxy_new_for_bus_sync = Interop.downcallHandle(
                "goa_contacts_proxy_new_for_bus_sync", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_contacts_proxy_new_sync = Interop.downcallHandle(
                "goa_contacts_proxy_new_sync", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_contacts_proxy_new = Interop.downcallHandle(
                "goa_contacts_proxy_new", FunctionDescriptor.ofVoid(ValueLayout.ADDRESS,
                ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_contacts_proxy_new_for_bus = Interop.downcallHandle(
                "goa_contacts_proxy_new_for_bus", FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT,
                ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);
    }
}
