...
public interface Music extends Proxy {
    ...
    /**
     * The Music$Impl type represents a native instance of the Music interface.
     */
    class Music$Impl extends GObject implements Music {
        static {
         ...
         */
        public Music$Impl(MemorySegment address) {
            super(address);
        }
    }
