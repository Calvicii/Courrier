...
public interface Contacts extends Proxy {
     ...
     *
     * @return The property value or {@code null} if the property is not set. Do not free the returned value, it belongs to this Contacts.
     */
    ...
    /**
     * The ContactsImpl type represents a native instance of the Contacts interface.
     */
    class ContactsImpl extends GObject implements Contacts {
        static {
         ...
         */
        public ContactsImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class ContactsIface extends TypeInterface {
        ...
        /**
         * Allocate a new ContactsIface.
         *
         * @param arena to control the memory allocation scope
         */
        public ContactsIface(Arena arena) {
        ...
        private int getAcceptSslErrorsUpcall(MemorySegment object) {
            try {
                ...
                var _objectCached = (Contacts) InstanceCache.getForType(object, ContactsImpl::new);
                if (_objectCached instanceof GObject _gobject) {
                    _gobject.ref();
                }
                var _result = (boolean) this._getAcceptSslErrorsMethod.invoke((Contacts) InstanceCache.getForType(object, ContactsImpl::new));
                return _result ? 1 : 0;
        ...
        private MemorySegment getUriUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getUriMethod.invoke((Contacts) InstanceCache.getForType(object, ContactsImpl::new));
