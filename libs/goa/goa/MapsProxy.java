...
/**
 * The {@code GoaMapsProxy} structure contains only private data and should only be accessed using the provided API.
 *
 * @since 3.14.0
 */
@Generated("io.github.jwharm.JavaGI")
@Deprecated
public class MapsProxy extends DBusProxy implements AsyncInitable, DBusInterface, Initable, Maps {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a MapsProxy proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public MapsProxy(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new MapsProxy.
     */
    public MapsProxy() {
    ...
    /**
     * Get the GType of the MapsProxy class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_maps_proxy_get_type");
    }
     ...
     * parent type.
     */
    protected MapsProxy asParent() {
        MapsProxy _parent = new MapsProxy(handle());
     ...
     *
     * @param res The {@code GAsyncResult} obtained from the {@code GAsyncReadyCallback} passed to goa_maps_proxy_new().
     ...
     */
    @Deprecated
    public static MapsProxy finish(AsyncResult res) throws GErrorException {
        var _result = constructFinish(res);
        return (MapsProxy) InstanceCache.getForType(_result, MapsProxy::new);
    }
    ...
    private static MemorySegment constructFinish(AsyncResult res) throws GErrorException {
        try (var _arena = Arena.ofConfined()) {
            ...
            try {
                _result = (MemorySegment) MethodHandles.goa_maps_proxy_new_finish.invokeExact(
     ...
     *
     * @param res The {@code GAsyncResult} obtained from the {@code GAsyncReadyCallback} passed to goa_maps_proxy_new_for_bus().
     * @return The constructed proxy object or {@code null} if {@code error} is set.
     * @throws GErrorException see {@link org.gnome.glib.GError}
     * @since 3.14.0
     * @deprecated The D-Bus interface has been deprecated.
     */
    @Deprecated
    public static MapsProxy forBusFinish(AsyncResult res) throws GErrorException {
    ...
    private static MemorySegment constructForBusFinish(AsyncResult res) throws GErrorException {
        try (var _arena = Arena.ofConfined()) {
            ...
            MemorySegment _result;
            try {
                _result = (MemorySegment) MethodHandles.goa_maps_proxy_new_for_bus_finish.invokeExact(
                        (MemorySegment) (res == null ? MemorySegment.NULL : res.handle()), _gerror);
            } catch (Throwable _err) {
                throw new AssertionError(_err);
            }
    ...
    /**
     * Like goa_maps_proxy_new_sync() but takes a {@code GBusType} instead of a {@code GDBusConnection}.
     * <p>
     ...
     */
    @Deprecated
    public static MapsProxy forBusSync(BusType busType, Set<DBusProxyFlags> flags, String name,
    ...
    private static MemorySegment constructForBusSync(BusType busType, Set<DBusProxyFlags> flags,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            MemorySegment _result;
            try {
                _result = (MemorySegment) MethodHandles.goa_maps_proxy_new_for_bus_sync.invokeExact(
     ...
     */
    @Deprecated
    public static MapsProxy forBusSync(BusType busType, DBusProxyFlags flags, String name,
            String objectPath, @Nullable Cancellable cancellable) throws GErrorException {
     ...
     */
    @Deprecated
    public static MapsProxy sync(DBusConnection connection, Set<DBusProxyFlags> flags,
    ...
    private static MemorySegment constructSync(DBusConnection connection, Set<DBusProxyFlags> flags,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            MemorySegment _result;
            try {
                _result = (MemorySegment) MethodHandles.goa_maps_proxy_new_sync.invokeExact(
     ...
     */
    @Deprecated
    public static MapsProxy sync(DBusConnection connection, DBusProxyFlags flags,
            @Nullable String name, String objectPath, @Nullable Cancellable cancellable) throws
            GErrorException {
    ...
    public static void new_(DBusConnection connection, Set<DBusProxyFlags> flags,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            try {
                MethodHandles.goa_maps_proxy_new.invokeExact(
                        (MemorySegment) (connection == null ? MemorySegment.NULL : connection.handle()), 
                        Interop.enumSetToInt(flags), 
                        (MemorySegment) (name == null ? MemorySegment.NULL : Interop.allocateNativeString(name, _arena)), 
                        (MemorySegment) (objectPath == null ? MemorySegment.NULL : Interop.allocateNativeString(objectPath, _arena)), 
    ...
    /**
     * Like goa_maps_proxy_new() but takes a {@code GBusType} instead of a {@code GDBusConnection}.
     * <p>
     * When the operation is finished, {@code callback} will be invoked in the thread-default main loop of the thread you are calling this method from (see g_main_context_push_thread_default()).
    ...
    public static void newForBus(BusType busType, Set<DBusProxyFlags> flags, String name,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            if (callback != null) ArenaCloseAction.CLEANER.register(callback, new ArenaCloseAction(_callbackScope));
            try {
                MethodHandles.goa_maps_proxy_new_for_bus.invokeExact(busType.getValue(), 
                        Interop.enumSetToInt(flags), 
                        (MemorySegment) (name == null ? MemorySegment.NULL : Interop.allocateNativeString(name, _arena)), 
                        (MemorySegment) (objectPath == null ? MemorySegment.NULL : Interop.allocateNativeString(objectPath, _arena)), 
                        (MemorySegment) (cancellable == null ? MemorySegment.NULL : cancellable.handle()), 
    ...
    /**
     * A {@link Builder} object constructs a {@code MapsProxy}
    ...
    /**
     * Class structure for {@code GoaMapsProxy}.
     *
     * @since 3.14.0
     */
    @Deprecated
    public static class MapsProxyClass extends DBusProxy.DBusProxyClass {
        /**
         * Create a MapsProxyClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public MapsProxyClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new MapsProxyClass.
         *
         * @param arena to control the memory allocation scope
         */
        public MapsProxyClass(Arena arena) {
    ...
    public static class Builder<B extends Builder<B>> extends DBusProxy.Builder<B> {
        ...
        /**
         * Finish building the {@code MapsProxy} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code MapsProxy}.
         *
         * @return a new instance of {@code MapsProxy} with the properties
         *         that were set in the Builder object.
         */
        public MapsProxy build() {
            try {
                var _instance = (MapsProxy) GObject.withProperties(MapsProxy.getType(), getNames(), getValues());
    ...
    private static final class MethodHandles {
        static final MethodHandle goa_maps_proxy_new_finish = Interop.downcallHandle(
                "goa_maps_proxy_new_finish", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_maps_proxy_new_for_bus_finish = Interop.downcallHandle(
                "goa_maps_proxy_new_for_bus_finish", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_maps_proxy_new_for_bus_sync = Interop.downcallHandle(
                "goa_maps_proxy_new_for_bus_sync", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.JAVA_INT, ValueLayout.JAVA_INT, ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_maps_proxy_new_sync = Interop.downcallHandle(
                "goa_maps_proxy_new_sync", FunctionDescriptor.of(ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS), false);

        static final MethodHandle goa_maps_proxy_new = Interop.downcallHandle("goa_maps_proxy_new",
                FunctionDescriptor.ofVoid(ValueLayout.ADDRESS, ValueLayout.JAVA_INT,
                ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS, ValueLayout.ADDRESS,
                ValueLayout.ADDRESS), false);

        static final MethodHandle goa_maps_proxy_new_for_bus = Interop.downcallHandle(
                "goa_maps_proxy_new_for_bus", FunctionDescriptor.ofVoid(ValueLayout.JAVA_INT,
