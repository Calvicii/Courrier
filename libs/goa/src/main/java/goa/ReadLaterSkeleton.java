...
/**
 * The {@code GoaReadLaterSkeleton} structure contains only private data and should only be accessed using the provided API.
 *
 * @since 3.12.0
 */
@Generated("io.github.jwharm.JavaGI")
@Deprecated
public class ReadLaterSkeleton extends DBusInterfaceSkeleton implements DBusInterface, ReadLater {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a ReadLaterSkeleton proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public ReadLaterSkeleton(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new ReadLaterSkeleton.
     */
    ...
    /**
     * Get the GType of the ReadLaterSkeleton class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_read_later_skeleton_get_type");
    }
     ...
     * parent type.
     */
    protected ReadLaterSkeleton asParent() {
        ReadLaterSkeleton _parent = new ReadLaterSkeleton(handle());
        _parent.callParent(true);
        return _parent;
    }

    /**
     * A {@link Builder} object constructs a {@code ReadLaterSkeleton}
    ...
    /**
     * Class structure for {@code GoaReadLaterSkeleton}.
     *
     * @since 3.12.0
     */
    @Deprecated
    public static class ReadLaterSkeletonClass extends DBusInterfaceSkeleton.DBusInterfaceSkeletonClass {
        /**
         * Create a ReadLaterSkeletonClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public ReadLaterSkeletonClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new ReadLaterSkeletonClass.
         *
         * @param arena to control the memory allocation scope
         */
        public ReadLaterSkeletonClass(Arena arena) {
        ...
        public static MemoryLayout getMemoryLayout() {
            ...
            ).withName("GoaReadLaterSkeletonClass");
        }
    }
    ...
    public static class Builder<B extends Builder<B>> extends DBusInterfaceSkeleton.Builder<B> {
        ...
        /**
         * Finish building the {@code ReadLaterSkeleton} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code ReadLaterSkeleton}.
         *
         * @return a new instance of {@code ReadLaterSkeleton} with the properties
         *         that were set in the Builder object.
         */
        public ReadLaterSkeleton build() {
            try {
                var _instance = (ReadLaterSkeleton) GObject.withProperties(ReadLaterSkeleton.getType(), getNames(), getValues());
