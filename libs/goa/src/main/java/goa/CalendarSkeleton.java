...
/**
 * The {@code GoaCalendarSkeleton} structure contains only private data and should only be accessed using the provided API.
 */
@Generated("io.github.jwharm.JavaGI")
public class CalendarSkeleton extends DBusInterfaceSkeleton implements DBusInterface, Calendar {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a CalendarSkeleton proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public CalendarSkeleton(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new CalendarSkeleton.
     */
    ...
    /**
     * Get the GType of the CalendarSkeleton class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_calendar_skeleton_get_type");
    }
     ...
     * parent type.
     */
    protected CalendarSkeleton asParent() {
        CalendarSkeleton _parent = new CalendarSkeleton(handle());
        _parent.callParent(true);
        return _parent;
    }

    /**
     * A {@link Builder} object constructs a {@code CalendarSkeleton}
    ...
    /**
     * Class structure for {@code GoaCalendarSkeleton}.
     */
    public static class CalendarSkeletonClass extends DBusInterfaceSkeleton.DBusInterfaceSkeletonClass {
        /**
         * Create a CalendarSkeletonClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public CalendarSkeletonClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new CalendarSkeletonClass.
         *
         * @param arena to control the memory allocation scope
         */
        public CalendarSkeletonClass(Arena arena) {
        ...
        public static MemoryLayout getMemoryLayout() {
            ...
            ).withName("GoaCalendarSkeletonClass");
        }
    }
     ...
     */
    public static class Builder<B extends Builder<B>> extends DBusInterfaceSkeleton.Builder<B> implements Calendar.Builder<B> {
        /**
        ...
        /**
         * Finish building the {@code CalendarSkeleton} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code CalendarSkeleton}.
         *
         * @return a new instance of {@code CalendarSkeleton} with the properties
         *         that were set in the Builder object.
         */
        public CalendarSkeleton build() {
            try {
                var _instance = (CalendarSkeleton) GObject.withProperties(CalendarSkeleton.getType(), getNames(), getValues());
