...
public interface OAuthBased extends Proxy {
    ...
    /**
     * Asynchronously invokes the &lt;link linkend="gdbus-method-org-gnome-OnlineAccounts-OAuthBased.GetAccessToken"&gt;GetAccessToken()&lt;/link&gt; D-Bus method on this OAuthBased.
    ...
    default boolean callGetAccessTokenFinish(@Nullable Out<String> outAccessToken,
        ...
        try (var _arena = Arena.ofConfined()) {
            ...
            if (outAccessTokenSecret != null) {
                outAccessTokenSecret.set(Interop.getStringFrom(_outAccessTokenSecretPointer.get(ValueLayout.ADDRESS, 0), true));
            }
    ...
    /**
     * Synchronously invokes the &lt;link linkend="gdbus-method-org-gnome-OnlineAccounts-OAuthBased.GetAccessToken"&gt;GetAccessToken()&lt;/link&gt; D-Bus method on this OAuthBased. The calling thread is blocked until a reply is received.
     * <p>
     ...
     *
     * @return The property value or {@code null} if the property is not set. Do not free the returned value, it belongs to this OAuthBased.
     */
    ...
    /**
     * The OAuthBasedImpl type represents a native instance of the OAuthBased interface.
     */
    class OAuthBasedImpl extends GObject implements OAuthBased {
        static {
         ...
         */
        public OAuthBasedImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class OAuthBasedIface extends TypeInterface {
        ...
        /**
         * Allocate a new OAuthBasedIface.
         *
         * @param arena to control the memory allocation scope
         */
        public OAuthBasedIface(Arena arena) {
        ...
        private int handleGetAccessTokenUpcall(MemorySegment object, MemorySegment invocation) {
            try {
                ...
                var _objectCached = (OAuthBased) InstanceCache.getForType(object, OAuthBasedImpl::new);
                ...
                var _result = (boolean) this._handleGetAccessTokenMethod.invoke((OAuthBased) InstanceCache.getForType(object, OAuthBasedImpl::new), (DBusMethodInvocation) InstanceCache.getForType(invocation, DBusMethodInvocation::new));
                return _result ? 1 : 0;
        ...
        private MemorySegment getConsumerKeyUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getConsumerKeyMethod.invoke((OAuthBased) InstanceCache.getForType(object, OAuthBasedImpl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, ite.getCause().toString() + " in " + _getConsumerKeyMethod);
        ...
        private MemorySegment getConsumerSecretUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getConsumerSecretMethod.invoke((OAuthBased) InstanceCache.getForType(object, OAuthBasedImpl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, ite.getCause().toString() + " in " + _getConsumerSecretMethod);
                return MemorySegment.NULL;
            } catch (Exception e) {
                throw new RuntimeException(e);
            }
