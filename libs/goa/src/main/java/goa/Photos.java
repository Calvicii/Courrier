...
public interface Photos extends Proxy {
    /**
     * Get the GType of the Photos class
     *
     * @return the GType
     */
    static Type getType() {
        return Interop.getType("goa_photos_get_type");
    }
    ...
    static DBusInterfaceInfo interfaceInfo() {
        ...
        try {
            _result = (MemorySegment) PhotosMethodHandles.goa_photos_interface_info.invokeExact();
    ...
    /**
     * Overrides all {@code GObject} properties in the {@code GoaPhotos} interface for a concrete class.
    ...
    static int overrideProperties(GObject.ObjectClass klass, int propertyIdBegin) {
        int _result;
        try {
            _result = (int) PhotosMethodHandles.goa_photos_override_properties.invokeExact(
    ...
    /**
     * The Photos$Impl type represents a native instance of the Photos interface.
     */
    class Photos$Impl extends GObject implements Photos {
        static {
            Goa.javagi$ensureInitialized();
        }

        /**
         * Creates a new instance of Photos for the provided memory address.
         *
         * @param address the memory address of the instance
         */
        public Photos$Impl(MemorySegment address) {
            super(address);
        }
    }
     ...
     * @since 3.8.0
     */
    class PhotosIface extends TypeInterface {
        /**
         * Create a PhotosIface proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public PhotosIface(MemorySegment address) {
