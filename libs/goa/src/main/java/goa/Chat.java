...
public interface Chat extends Proxy {
    ...
    /**
     * The ChatImpl type represents a native instance of the Chat interface.
     */
    class ChatImpl extends GObject implements Chat {
        static {
         ...
         */
        public ChatImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class ChatIface extends TypeInterface {
        ...
        /**
         * Allocate a new ChatIface.
         *
         * @param arena to control the memory allocation scope
         */
        public ChatIface(Arena arena) {
