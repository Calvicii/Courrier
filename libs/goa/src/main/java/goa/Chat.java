...
public interface Chat extends Proxy {
    /**
     * Get the GType of the Chat class
     *
     * @return the GType
     */
    static Type getType() {
        return Interop.getType("goa_chat_get_type");
    }
    ...
    static DBusInterfaceInfo interfaceInfo() {
        ...
        try {
            _result = (MemorySegment) ChatMethodHandles.goa_chat_interface_info.invokeExact();
    ...
    /**
     * Overrides all {@code GObject} properties in the {@code GoaChat} interface for a concrete class.
    ...
    static int overrideProperties(GObject.ObjectClass klass, int propertyIdBegin) {
        int _result;
        try {
            _result = (int) ChatMethodHandles.goa_chat_override_properties.invokeExact(
    ...
    /**
     * The Chat$Impl type represents a native instance of the Chat interface.
     */
    class Chat$Impl extends GObject implements Chat {
        static {
            Goa.javagi$ensureInitialized();
        }

        /**
         * Creates a new instance of Chat for the provided memory address.
         *
         * @param address the memory address of the instance
         */
        public Chat$Impl(MemorySegment address) {
            super(address);
        }
    }
     ...
     */
    class ChatIface extends TypeInterface {
        /**
         * Create a ChatIface proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public ChatIface(MemorySegment address) {
