...
public interface Todo extends Proxy {
    ...
    /**
     * The TodoImpl type represents a native instance of the Todo interface.
     */
    class TodoImpl extends GObject implements Todo {
        static {
         ...
         */
        public TodoImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class TodoIface extends TypeInterface {
        ...
        /**
         * Allocate a new TodoIface.
         *
         * @param arena to control the memory allocation scope
         */
        public TodoIface(Arena arena) {
