...
/**
 * The {@code GoaExchangeSkeleton} structure contains only private data and should only be accessed using the provided API.
 *
 * @since 3.6.0
 */
@Generated("io.github.jwharm.JavaGI")
public class ExchangeSkeleton extends DBusInterfaceSkeleton implements DBusInterface, Exchange {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a ExchangeSkeleton proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public ExchangeSkeleton(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new ExchangeSkeleton.
     */
    ...
    /**
     * Get the GType of the ExchangeSkeleton class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_exchange_skeleton_get_type");
    }
     ...
     * parent type.
     */
    protected ExchangeSkeleton asParent() {
        ExchangeSkeleton _parent = new ExchangeSkeleton(handle());
        _parent.callParent(true);
        return _parent;
    }

    /**
     * A {@link Builder} object constructs a {@code ExchangeSkeleton}
    ...
    /**
     * Class structure for {@code GoaExchangeSkeleton}.
     *
     * @since 3.6.0
     */
    public static class ExchangeSkeletonClass extends DBusInterfaceSkeleton.DBusInterfaceSkeletonClass {
        /**
         * Create a ExchangeSkeletonClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public ExchangeSkeletonClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new ExchangeSkeletonClass.
         *
         * @param arena to control the memory allocation scope
         */
        public ExchangeSkeletonClass(Arena arena) {
        ...
        public static MemoryLayout getMemoryLayout() {
            ...
            ).withName("GoaExchangeSkeletonClass");
        }
    }
     ...
     */
    public static class Builder<B extends Builder<B>> extends DBusInterfaceSkeleton.Builder<B> implements Exchange.Builder<B> {
        /**
        ...
        /**
         * Finish building the {@code ExchangeSkeleton} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code ExchangeSkeleton}.
         *
         * @return a new instance of {@code ExchangeSkeleton} with the properties
         *         that were set in the Builder object.
         */
        public ExchangeSkeleton build() {
            try {
                var _instance = (ExchangeSkeleton) GObject.withProperties(ExchangeSkeleton.getType(), getNames(), getValues());
