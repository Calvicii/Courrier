...
/**
 * The {@code GoaPhotosSkeleton} structure contains only private data and should only be accessed using the provided API.
 *
 * @since 3.8.0
 */
@Generated("io.github.jwharm.JavaGI")
public class PhotosSkeleton extends DBusInterfaceSkeleton implements DBusInterface, Photos {
    static {
        Goa.javagi$ensureInitialized();
    }

    /**
     * Create a PhotosSkeleton proxy instance for the provided memory address.
     *
     * @param address the memory address of the native object
     */
    public PhotosSkeleton(MemorySegment address) {
        super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
    }

    /**
     * Creates a new PhotosSkeleton.
     */
    ...
    /**
     * Get the GType of the PhotosSkeleton class
     *
     * @return the GType
     */
    public static Type getType() {
        return Interop.getType("goa_photos_skeleton_get_type");
    }
     ...
     * parent type.
     */
    protected PhotosSkeleton asParent() {
        PhotosSkeleton _parent = new PhotosSkeleton(handle());
        _parent.callParent(true);
        return _parent;
    }

    /**
     * A {@link Builder} object constructs a {@code PhotosSkeleton}
    ...
    /**
     * Class structure for {@code GoaPhotosSkeleton}.
     *
     * @since 3.8.0
     */
    public static class PhotosSkeletonClass extends DBusInterfaceSkeleton.DBusInterfaceSkeletonClass {
        /**
         * Create a PhotosSkeletonClass proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public PhotosSkeletonClass(MemorySegment address) {
            super(Interop.reinterpret(address, getMemoryLayout().byteSize()));
        }

        /**
         * Allocate a new PhotosSkeletonClass.
         *
         * @param arena to control the memory allocation scope
         */
        public PhotosSkeletonClass(Arena arena) {
        ...
        public static MemoryLayout getMemoryLayout() {
            ...
            ).withName("GoaPhotosSkeletonClass");
        }
    }
    ...
    public static class Builder<B extends Builder<B>> extends DBusInterfaceSkeleton.Builder<B> {
        ...
        /**
         * Finish building the {@code PhotosSkeleton} object. This will call
         * {@link GObject#withProperties} to create a new GObject instance,
         * which is then cast to {@code PhotosSkeleton}.
         *
         * @return a new instance of {@code PhotosSkeleton} with the properties
         *         that were set in the Builder object.
         */
        public PhotosSkeleton build() {
            try {
                var _instance = (PhotosSkeleton) GObject.withProperties(PhotosSkeleton.getType(), getNames(), getValues());
