...
public interface Calendar extends Proxy {
     ...
     *
     * @return The property value or {@code null} if the property is not set. Do not free the returned value, it belongs to this Calendar.
     */
    ...
    /**
     * The CalendarImpl type represents a native instance of the Calendar interface.
     */
    class CalendarImpl extends GObject implements Calendar {
        static {
         ...
         */
        public CalendarImpl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class CalendarIface extends TypeInterface {
        ...
        /**
         * Allocate a new CalendarIface.
         *
         * @param arena to control the memory allocation scope
         */
        public CalendarIface(Arena arena) {
        ...
        private int getAcceptSslErrorsUpcall(MemorySegment object) {
            try {
                ...
                var _objectCached = (Calendar) InstanceCache.getForType(object, CalendarImpl::new);
                if (_objectCached instanceof GObject _gobject) {
                    _gobject.ref();
                }
                var _result = (boolean) this._getAcceptSslErrorsMethod.invoke((Calendar) InstanceCache.getForType(object, CalendarImpl::new));
                return _result ? 1 : 0;
        ...
        private MemorySegment getUriUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getUriMethod.invoke((Calendar) InstanceCache.getForType(object, CalendarImpl::new));
