...
@Deprecated
public interface Documents extends Proxy {
    /**
     * Get the GType of the Documents class
     *
     * @return the GType
     */
    static Type getType() {
        return Interop.getType("goa_documents_get_type");
    }
    ...
    static DBusInterfaceInfo interfaceInfo() {
        ...
        try {
            _result = (MemorySegment) DocumentsMethodHandles.goa_documents_interface_info.invokeExact(
                    );
    ...
    /**
     * Overrides all {@code GObject} properties in the {@code GoaDocuments} interface for a concrete class.
    ...
    static int overrideProperties(GObject.ObjectClass klass, int propertyIdBegin) {
        int _result;
        try {
            _result = (int) DocumentsMethodHandles.goa_documents_override_properties.invokeExact(
    ...
    /**
     * The Documents$Impl type represents a native instance of the Documents interface.
     */
    class Documents$Impl extends GObject implements Documents {
        static {
            Goa.javagi$ensureInitialized();
        }

        /**
         * Creates a new instance of Documents for the provided memory address.
         *
         * @param address the memory address of the instance
         */
        public Documents$Impl(MemorySegment address) {
            super(address);
        }
    }
     ...
     */
    @Deprecated
    class DocumentsIface extends TypeInterface {
        /**
         * Create a DocumentsIface proxy instance for the provided memory address.
         *
         * @param address the memory address of the native object
         */
        public DocumentsIface(MemorySegment address) {
