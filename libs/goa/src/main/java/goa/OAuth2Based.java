...
public interface OAuth2Based extends Proxy {
    ...
    /**
     * Asynchronously invokes the &lt;link linkend="gdbus-method-org-gnome-OnlineAccounts-OAuth2Based.GetAccessToken"&gt;GetAccessToken()&lt;/link&gt; D-Bus method on {@code proxy.}
    ...
    /**
     * Synchronously invokes the &lt;link linkend="gdbus-method-org-gnome-OnlineAccounts-OAuth2Based.GetAccessToken"&gt;GetAccessToken()&lt;/link&gt; D-Bus method on {@code proxy.} The calling thread is blocked until a reply is received.
     * <p>
    ...
    /**
     * The OAuth2Based$Impl type represents a native instance of the OAuth2Based interface.
     */
    class OAuth2Based$Impl extends GObject implements OAuth2Based {
        static {
         ...
         */
        public OAuth2Based$Impl(MemorySegment address) {
            super(address);
        }
    }
    ...
    class OAuth2BasedIface extends TypeInterface {
        ...
        private int handleGetAccessTokenUpcall(MemorySegment object, MemorySegment invocation) {
            try {
                ...
                var _objectCached = (OAuth2Based) InstanceCache.getForType(object, OAuth2Based$Impl::new);
                ...
                var _result = (boolean) this._handleGetAccessTokenMethod.invoke((OAuth2Based) InstanceCache.getForType(object, OAuth2Based$Impl::new), (DBusMethodInvocation) InstanceCache.getForType(invocation, DBusMethodInvocation::new));
                return _result ? 1 : 0;
        ...
        private MemorySegment getClientIdUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getClientIdMethod.invoke((OAuth2Based) InstanceCache.getForType(object, OAuth2Based$Impl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getClientIdMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getClientIdMethod");
                return MemorySegment.NULL;
            }
        }
        ...
        private MemorySegment getClientSecretUpcall(MemorySegment object) {
            try {
                ...
                var _result = (String) this._getClientSecretMethod.invoke((OAuth2Based) InstanceCache.getForType(object, OAuth2Based$Impl::new));
                if (_result == null) return MemorySegment.NULL;
                return Interop.allocateNativeString(_result, _arena);
            } catch (InvocationTargetException _ite) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _ite.getCause().toString() + " in _getClientSecretMethod");
                return MemorySegment.NULL;
            } catch (Throwable _t) {
                GLib.log(Constants.LOG_DOMAIN, LogLevelFlags.LEVEL_WARNING, _t.toString() + " in _getClientSecretMethod");
                return MemorySegment.NULL;
            }
        }
    }
